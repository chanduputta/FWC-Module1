...
\tableofcontents
  \begin{abstract}
    This manual shows the implementation of 4to2 encoder instructions in AVR GCC compiler          
    in C language using Arduino UNO.
...
\begin{lstlisting}
https://github.com/chanduputta/FWCassignments/tree/main/AVR%20GCC%20assignment/code
\end{lstlisting}
