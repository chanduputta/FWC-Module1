\def\mytitle{4to2 Encoder - on ESP32(IOT Appliction)}
...
\tableofcontents
  \begin{abstract}
      This manual shows the implementation of 4to2 encoder using FPGA in vaman board.
...
\paragraph{}
2,4,5,10 Pins of vaman board are manually given inputs as D1,D2,D3,D0 Respectively and verify the logic of Q0,Q1 in Table 1
...
Built in LED at pin-32 of Vaman-esp32 will glow for the logic'1' of Q1,and off for the logic'0' of Q1  and a LED circuit at pin-33 of Vaman-esp32 will glow for the logic'1' of Q0,and off for the logic'0' of Q0
\begin{lstlisting}
https://github.com/chanduputta/FWC-Module1/tree/main/iot-assignment
\end{lstlisting}
Clone this folder of repository and Follow given Instructions termuxubuntu.txt file to compile and send the code using bash(.sh) files 
